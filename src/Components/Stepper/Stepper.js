...
const Stepper = ({ steps, currentStep }) => {
	...
	const stepsDisplay = newStep.map((step, index) => {
		return (
			...
			>
				...
				>
					<div
						className={`flex rounded-full transition duration-500 ease-in-out border-2 border-gray-300 h-12 w-12 items-center justify-center  ${
							step.selected
	...
	return (
		<div className="flex  mx-auto px-3 md:px-0 mp-14 justify-between items-center" style={{marginTop:'10px', width:'60%'}}>
			{stepsDisplay}
		</div>
	);
};
